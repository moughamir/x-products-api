...
class ApiController
{
     ...
     * @OA\Parameter(name="path", in="path", required=true, description="The path to the image on the external CDN. Can include slashes and subdirectories.", @OA\Schema(type="string", example="s/files/1/0000/0000/products/image.jpg")),
